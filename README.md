...
- MongoDB Atlas URI: The project uses the MongoDB Atlas connection URI: `"mongodb+srv://samarmittal59:Qwerty%40123@cluster0.raeompg.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"`.
- Database Name: The project uses a database named `"newsfetcher"` in the MongoDB Atlas cluster.
- Collection Name: The project inserts data into a collection named `"geonews"`.
